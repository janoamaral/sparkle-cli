...
var spanishTranslations = map[string]string{
	...
	"status.source_search_prompt":      "Buscar en la fuente: escribe termino y presiona Enter.",
	"status.source_search_empty":       "Busqueda limpiada.",
	"status.source_search_results":     "%d resultados encontrados.",
	"status.source_search_title":       "Buscar en la fuente",
	"status.source_search_placeholder": "Palabras a buscar...",
